...
public class CampaignHelper2 {
	
	static Logger log =  LoggerFactory.getLogger(CampaignHelper2.class);
	...
	public static List<Hit> getAllCampaigns(ResourceResolver resovler) {
		...
		queryParams.put("property", "jcr:primaryType");
		queryParams.put("property.value", "nt:unstructured");
