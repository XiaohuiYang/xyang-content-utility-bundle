...
@Component(immediate=true, label="Campaign query", metatype=true)
@Service
@Property(name="sling.servlet.paths", value="/bin/xyang/allcampaigns")
public class CampaignQuery extends SlingAllMethodsServlet{
	...
	protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		...
		List<Hit> list = CampaignHelper.getAllCampaigns(resolver);
		...
		for (Hit hit:list) {
			...
			try {
				...
				javax.jcr.Property startValue;
					...
					startValue = cam.getProperty("startDate");
